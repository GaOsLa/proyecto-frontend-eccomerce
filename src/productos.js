const productos = [
    {
      ...
      caracteristicas:"Fotografía profesional en tu bolsillo: Descubrí infinitas posibilidades para tus fotos con las 3 cámaras principales de tu equipo. Experimentá con la iluminación, diferentes planos y efectos para obtener resultados sorprendentes. Disfrutá de una experiencia visual increíble en su pantalla Super AMOLED de 6.5, con colores brillantes y detalles precisos. Potenciado por un procesador y 6 GB de RAM para un rendimiento rápido y eficiente. Garantiza máxima seguridad con desbloqueo facial y dactilar. La batería de 4500 mAh proporciona una duración superior, permitiéndote disfrutar de tus actividades sin preocupaciones.",
      // envios:"Nuestros envíos son rápidos y confiables, garantizando una pronta llegada de tus productos directamente a tu puerta. ¡Y eso no es todo! Para brindarte un trato aún más especial, tu primer envío es completamente gratis. Además, disfrutarás de una experiencia de compra sin complicaciones, atención al cliente excepcional y una amplia gama de productos de alta calidad. ¡Te damos la bienvenida a una forma más conveniente y beneficiosa de comprar!"
    },
    {
      codigo: 2,
